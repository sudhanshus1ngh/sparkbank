...
<div  class="col-lg-6 col-md-6 col-12">
      ...
      <p1> The Sparks Bank is a part of The Sparks Bank. It is one of nations's leading private banks and was among the first to receive approval from the Central bank of Znation (CBZ) to set up a private sector bank in 992 ZY.
          Today, The Sparks Bank has a banking network of 6,000 branches and 25,400 ATM's in 320 cities/towns. The Sparks Bank offers a diverse range of financial products and banking services to customers through a growing branch and ATM network and digital channels such as Netbanking, Phonebanking and MobileBanking.
...
<div class="py-5">
 ...
 <p1>This website is the
      ...
      acknowledged within the website. Anyone may reproduce, distribute, adapt, translate the content on the website, without explicit permission, provided that the content is accompanied by an acknowledgement that The Sparks Bank website is the source and that it is clearly indicated if changes were made to the original content.</p1>
 </div>



<footer class="text-center mt-2 py-5">
        <p>&copy 2022  |<b>Sudhanshu Singh</b> </br>Creator, The Sparks Bank</p>
      </footer>
